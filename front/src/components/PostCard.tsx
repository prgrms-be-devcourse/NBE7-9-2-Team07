...
export default function PostCard({ pin, onClick }: { pin: PinDto; onClick: () => void }) {
  return (
    <div className="border rounded-md p-3 cursor-pointer hover:bg-blue-50 transition" onClick={onClick}>
